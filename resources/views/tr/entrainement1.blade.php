    ...
    start : function() { // fonction start
		...
		function time(){
            ...
            context.fillRect(0,0,2000,2000);
				...
				var txt = 'Çok iyi! Şimdi "F" tuşuna basarak füzeleri ateşleme alıştırması yapabilirsiniz.';
    		    context.fillText(txt, 10, 300);
    		    game.redirect = true;
		    }
		}
...
this.timeStart = timeStart;
   ...
   function wrapText(context, text, x, y, maxWidth, lineHeight) {
	...
	function message() {
		this.text1 = "{{ __('game.text1') }}";
		this.text2 = "{{ __('game.text2') }}";		
		this.text3 = "{{ __('game.text3') }}";
		this.text4 = "{{ __('game.text4') }}";		
		...
		this.draw = function() {
			...
			var x = 100;
			var y = 250;
			wrapText(context, this.text, x, y, maxWidth, lineHeight);
		}
	}
