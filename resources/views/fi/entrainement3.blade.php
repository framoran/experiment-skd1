...
this.timeStart = timeStart;
  ...
  function message() {
	...
	this.longueur = 150;
	this.color = "#01DF01";
	this.text = 'Paina C-kirjainta nähdäksesi polttoainemittarin.';
	this.tx = 190;
	this.score1 = 0;
	...
	this.draw = function() {
		...
		context.fillText("Polttoaine", this.x, this.y);
		...
		if ((game.keyCode2 == true) && (myGamePiece_Affichage.keypress == false)) {
		    ...
		    keyRestore = function(){
               ...
               if (game.update < 1){
                   game.update += 1;
                   myGamePiece_Affichage.text = 'Paina C-kirjainta toisen kerran nähdäksesi polttoainemittarin uudelleen.';
                   myGamePiece_Affichage.tx = 50;
               }
