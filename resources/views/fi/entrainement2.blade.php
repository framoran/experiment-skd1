	...
	function Evenement() {
	    this.update = function(){
        	...
        	if (game.keyCode1 == true && myGamePiece_Missile.nouveau_tir == false) {
        		...
        		if (game.tirs < 1 ) {
        		    game.tirs += 1;
            		myGamePiece_Affichage.text = 'Ammu uudestaan painamalla F-kirjainta.';
            		myGamePiece_Affichage.x = 250;
        		}
        		else if (game.tirs >= 1 ) {
            		myGamePiece_Affichage.text = 'Ammu uudestaan painamalla F-kirjainta.';
            		myGamePiece_Affichage.x = 250;
...
function updateGame() {
	...
	context.font= "25px Verdana";
	context.fillStyle = "#FFFFFF";
	context.fillText(myGamePiece_Affichage.text, myGamePiece_Affichage.x, 250);
