...
<body onload=startGame() style=background-color:black>
    ...
    <script>
        ...
        text_press_fuel_display_1 = "{!! __('game.text_press_fuel_display_3') !!}";
        text_press_fuel_display_2 = "{!! __('game.text_press_fuel_display_4') !!}";
        text_press_fuel_touch_1 = "{!! __('game.text_press_fuel_display_3') !!}";
        text_press_fuel_touch_2 = "{!! __('game.text_press_fuel_display_4') !!}";

    </script>

    <script src="/js/practice_focus.js?v=2">
