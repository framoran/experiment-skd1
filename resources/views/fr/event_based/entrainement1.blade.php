    ...
    start : function() { // fonction start
		...
		function time(){
		    if (game.checkUpdate == false){
    		    ...
    		    context.fillText("Très bien! Maintenant, vous allez pouvoir vous entrainer", 150, 300);
    		    context.fillText("à tirer des missiles en appuyant sur la touche F.", 200, 350);
    		    game.redirect = true;
		    }
		}
...
this.timeStart = timeStart;
  ...
  // OBJET message
  function message() {
    this.text1 = "Appuyez sur la flèche de droite (bas du clavier, flèche droite)";
    this.text2 = "Appuyez sur la flèche de gauche (bas du clavier, flèche gauche)";
    this.text3 = "Appuyez sur la flèche du haut (bas du clavier, flèche vers le haut)";
    this.text4 = "Appuyez sur la flèche du bas (bas du clavier, flèche vers le bas)";
    this.text_ligne = "jusqu’à ce que le vaisseau touche le bord de l’écran.";
...
function updateGame() {
	...
	context.font= "25px Verdana";
	context.fillStyle = "#FFFFFF";
	context.fillText(myGamePiece_Affichage.text, 100, 250);
	context.fillText(myGamePiece_Affichage.text_ligne, 150, 310);
