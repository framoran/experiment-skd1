...
var game = {
	...
	var cometInterval = 25000; // 30 seconds in milliseconds
...
this.timeStart = timeStart;
  ...
  function message() {
	...
	this.longueur = 150;
	this.color = "#01DF01";
	this.text = 'Appuyez sur "Barre Espace" dès que vous voyez une comète  ';
	this.tx = 150;
	this.score1 = 0;
	...
	this.draw = function() {
		...
		if (myGamePiece_DrawingComet.cometX < -1000){
			myGamePiece_DrawingComet.cometX = 2000;
		}
		console.log(myGamePiece_DrawingComet.cometX);
		//changeLongueur(myGamePiece_Affichage);
		//changeColor(myGamePiece_Affichage);
		console.log(game.update);
		if ((game.keyCode3 == true) && (myGamePiece_Affichage.keypress == false) && (myGamePiece_DrawingComet.cometX < 1000 && myGamePiece_DrawingComet.cometX > 0)) {
		    ...
		    keyRestore = function(){
               ...
               if (game.update < 1){
                   game.update += 1;
                   myGamePiece_Affichage.text = 'Appuyez à nouveau sur "Barre Espace" dès que vous voyez une comète.';
                   myGamePiece_Affichage.tx = 35;
               }
...
function updateGame() {
	...
	context.fillText("pour faire le plein de carburant.", 350, 300);
