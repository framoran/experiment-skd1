	...
	this.draw = function() {
		...
		if ((game.keyCode2 == true) && (myGamePiece_Affichage.keypress == false)) {
		    ...
		    keyRestore = function(){
               ...
               if (game.update < 1){
                   game.update += 1;
                   myGamePiece_Affichage.text = '再次按你键盘上的 “C” 键显示燃油表。';
                   myGamePiece_Affichage.tx = 300;
               }
...
function updateGame() {
	...
	context.font= "25px Verdana";
	context.fillStyle = "#FFFFFF";
	context.fillText(myGamePiece_Affichage.text, myGamePiece_Affichage.tx, 300);
