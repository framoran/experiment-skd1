...
this.timeStart = timeStart;
  ...
  function message() {
	...
	this.draw = function() {
		...
		context.fillText("سوخت", this.x+150, this.y);
		...
		context.stroke();
		context.fillText("بنزین زدی!", this.affichage_plein, 100);
		...
		if ((game.keyCode2 == true) && (myGamePiece_Affichage.keypress == false)) {
		    ...
		    keyRestore = function(){
               ...
               if (game.update < 1){
                   game.update += 1;
                   myGamePiece_Affichage.text = "{{ __('game.text6') }}";
                   myGamePiece_Affichage.tx = 900;
               }
